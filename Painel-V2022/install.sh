...
clear
echo -e "\E[44;1;37m    INSTALAR PAINELWEB CONEXAO NET     \E[0m" 
echo ""
echo -e "                 \033[1;31mBy @AlexandreDG\033[1;36m"
echo ""
...
wget https://raw.githubusercontent.com/Digulgasoft/gestor-web22/master/Painel-V2022/gestorssh.zip > /dev/null 2>&1
...
sleep 1
cd || exit
wget https://raw.githubusercontent.com/Digulgasoft/gestor-web22/master/Painel-V2022/bdgestorssh.sql > /dev/null 2>&1
sleep 1
...
clear
sleep 1
echo -e "\033[1;32m CONEXAO NET INSTALADO COM SUCESSO!"
echo ""
echo -e "                 \033[1;31mBy @AlexandreDG\033[1;36m"
echo ""
...
echo ""
echo -e "\033[1;33m MAIS INFORMAÇÕES \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37m@AlexandreDG\033[0m"
echo ""
