...
clear
tput setaf 7 ; tput setab 4 ; tput bold ; printf '%30s%s%-10s\n' "Instalador PainelWEB CONEXAO NET CENTOS 7" ; tput sgr0 ; echo ""
echo "Continuar? Y\n"
echo -n "> "
read option
if [ $option = "Y" ]; then
...
wget https://raw.githubusercontent.com/Digulgasoft/gestor-web22/master/Painel-V2022//phpMyAdmin.conf -O /etc/httpd/conf.d/phpMyAdmin.conf
...
installweb(){
cd /var/www/html
wget https://raw.githubusercontent.com/Digulgasoft/gestor-web22/master/Painel-V2022//gestorssh.zip
unzip gestorssh.zip
...
createdb(){
wget https://raw.githubusercontent.com/Digulgasoft/gestor-web22/master/Painel-V2022//bdgestorssh.sql
...
cd $HOME || exit
wget -qO- https://raw.githubusercontent.com/Digulgasoft/gestor-web22/master/Painel-V2022//uteste > /bin/usersteste.sh
wget -qO- https://raw.githubusercontent.com/Digulgasoft/gestor-web22/master/Painel-V2022//backupauto > /bin/autobackup.sh
