#!/bin/bash
clear
echo -e "\033[1;36mINSTALANDO O SINCRONIZADOR CONEXAO NET\033[0m"
...
wget https://raw.githubusercontent.com/Digulgasoft/gestor-web22/master/Painel-V2022/sshplus.zip.001 > /dev/null 2>&1
wget https://raw.githubusercontent.com/Digulgasoft/gestor-web22/master/Painel-V2022/sshplus.zip.002 > /dev/null 2>&1
wget https://raw.githubusercontent.com/Digulgasoft/gestor-web22/master/Painel-V2022/sshplus.zip.003 > /dev/null 2>&1
...
clear
wget https://raw.githubusercontent.com/Digulgasoft/gestor-web22/master/Painel-V2022/sincpainel.zip > /dev/null 2>&1
